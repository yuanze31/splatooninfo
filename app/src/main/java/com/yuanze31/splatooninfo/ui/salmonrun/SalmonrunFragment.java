package com.yuanze31.splatooninfo.ui.salmonrun;
...
import com.yuanze31.splatooninfo.databinding.FragmentSalmonrunBinding;
...
public class SalmonrunFragment extends Fragment implements Refreshable {

    private FragmentSalmonrunBinding binding;
    private SalmonrunViewModel salmonrunViewModel;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        salmonrunViewModel = new ViewModelProvider(this, new WebImgViewModelFactory(requireContext())).get(SalmonrunViewModel.class);
        binding = FragmentSalmonrunBinding.inflate(inflater,
                                                   container,
                                                   false);
        ...
        if (savedInstanceState == null) {
            webView.loadUrl("https://splatoon3.ink/salmonrun");
        } else {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
                String originalUrl = request.getUrl()
                                            .toString();
                String finalUrl = salmonrunViewModel.getImagePath(getContext(),
                                                                  originalUrl);
