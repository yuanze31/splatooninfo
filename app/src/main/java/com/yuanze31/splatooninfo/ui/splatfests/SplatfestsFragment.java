...
public class SplatfestsFragment extends Fragment implements Refreshable {

    private FragmentSplatfestsBinding binding;
    private SplatfestsViewModel splatfestsViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            webView.loadUrl("https://splatoon3.ink/splatfests");
        } else {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
                String originalUrl = request.getUrl()
                                            .toString();
                String finalUrl = splatfestsViewModel.getImagePath(getContext(),
                                                                   originalUrl);
